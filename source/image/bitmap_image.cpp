...
BitmapImage BitmapImage::transpose_parallel(int thread_count) const {
    auto transposed_image = BitmapImage(width, height);
...
BitmapImage BitmapImage::get_grayscale_parallel(int thread_count) const {
    auto gray_image = BitmapImage(height, width);
...
void BitmapImage::mystery_parallel(int thread_count) {
