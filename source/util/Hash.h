...
private:
    const static std::uint64_t m_A =  5'647'095'006'226'412'969;
    const static std::uint64_t m_B =  41'413'938'183'913'153;
    const static std::uint64_t m_C =   6'225'658'194'131'981'369;
